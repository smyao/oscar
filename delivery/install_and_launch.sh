...
export OSCAR_ASCEND_ASCENDC_MAX_SEQ_LEN="${OSCAR_ASCEND_ASCENDC_MAX_SEQ_LEN:-256}"
...
# 16K~32K 真机 A/B 中，128K 相比 64K 的高并发均值仅提升约 3%，中位数
# 反而下降；保持 64K 以控制 dense prepare 临时工作集和长尾。
